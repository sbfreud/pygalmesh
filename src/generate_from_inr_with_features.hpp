#ifndef GENERATE_FROM_INR_WITH_FEATURES_HPP
#define GENERATE_FROM_INR_WITH_FEATURES_HPP
...
void generate_from_inr_with_features(
...
#endif // GENERATE_FROM_INR_WITH_FEATURES_HPP
